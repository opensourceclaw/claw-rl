...
- **Security**: Fix 32 Dependabot npm vulnerabilities in Claude Code plugin
- **Compatibility**: Add graceful fallback for missing claw_mem dependency

### Added

- **CI/CD**: Add GitHub Actions workflows (test, release, lint)
- **Automation**: Add release checklist automation
- **Templates**: Add GitHub Issue and PR templates

### Changed

- **Structure**: Reorganize to Apache open-source project directory standard
- **Cleanup**: Remove temp files and update plugin build
