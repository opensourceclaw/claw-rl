...
"""
ParetoFront - Pareto 前沿calculate
"""
...
class ParetoFront:
    ...
    def select_elite(
        ...
        Args:
            solutions: 候选solutionlist
            n: 选择count
            use_crowding: 是否使用拥挤degree距离
